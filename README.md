...
- try solving the problem first before looking at the code
- think about alternative designs and tradeoffs

There’s almost always more than one reasonable way to build these systems.
